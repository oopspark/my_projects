...
\newcolumntype{C}[1]{>{\columncolor{gray!20}\arraybackslash}c}  % 고정폭 회색열
\newcolumntype{Y}{>{\columncolor{gray!20}\centering\arraybackslash}X}  % 가변폭 열 (tabularx 전용)
...
\include{part/chapter1}
\include{part/chapter2}
% 추가 장은 자유롭게 추가
